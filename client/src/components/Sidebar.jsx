        ...
        <div className='pb-5'>
            <div className='flex justify-between items-center'>
                ...
                <div className='relative py-2 group'>
                    ...
                    bg-[#282842] border border-gray-600 text-gray-100 hidden 
                    group-hover:block'>
            ...
            <div className='bg-[#282142] rounded-full flex items-center gap-2 px-3 py-2 mt-4'>
            ...
            {filteredUsers.map((user,index)=>(
                ...
                cursor-pointer max-sm:text-sm ${selectedUser?._id===user._id && 'bg-[#282142]/50'}`}>
                    ...
                    </div>
                    {
                        ...
                        flex justify-center items-center rounded-full bg-voilet-500/50'>
