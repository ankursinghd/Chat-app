    ...
    ${selectedUser?"max-md:hidden":""}`} >
      ...
      <div className='px-5 text-xs'>
       ...
       <div className="p-4 flex justify-center">
        <button onClick={()=>logout()} className='bg-gradient-to-r from-purple-400 to-violet-600
          text-white border-none text-sm font-light py-2 px-10 rounded-full cursor-pointer'>
          Logout
        </button>
      </div>
