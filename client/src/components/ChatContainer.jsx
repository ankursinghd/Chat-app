...
const ChatContainer = () => {
  ...
  return selectedUser? (
    <div className='h-full overflow-hidden relative backdrop-blur-lg'>
             ...
             ${msg.senderId!==authUser._id && 'flex-row-reverse'}`}>
              {msg.image?(
                ...
                <p className={`p-2 max-w-[200px] md:text-sm font-light
                  rounded-lg mb-8 break-all bg-voilet-500/30 text-white
     ...
     <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3 bg-black/20 backdrop-blur'>
  <div className='flex-1 flex items-center bg-white/10 px-4 py-2 rounded-full'>
    <input
      ...
      className="flex-1 text-sm border-none bg-transparent outline-none text-white placeholder-gray-400"
    />
